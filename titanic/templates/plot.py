...
class Plot(object):
    ...
    def draw_pclass(self):
        ...
        this["Pclass"] = this["Pclass"].replace(1, "First Class").replace(2, "Business").replace(3, "Economy")
    ...
    def draw_sex(self):
        ...
        plt.subplots(1, 1, figsize=(10, 8))
        this["Survived"] = this["Survived"].replace(0, "perish").replace(1, "Survived")
        sns.countplot(data=this, x="Sex", hue="Survived")
        '''
        f, ax = plt.subplots(1, 2, figsize=(18, 8))
    ...
    def draw_embarked(self):
        ...
        sns.countplot(date=this, x="Embarked", hue="Survived")
        plt.show()
